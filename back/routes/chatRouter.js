...
const {  getChats, checkOrCreateLocal, getMessageLocal,getLocalsChats, createChat, checkSubscribe,getChatMessages} = require('../controllers/chatController')
...
router.post(routes.chat.getChatMessages,getChatMessages)
